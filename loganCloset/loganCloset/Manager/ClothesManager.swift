...
final class ClothesManager {
    ...
    private let dummyCloset:[Clothes] = [
        ...
        Clothes(itemImage: UIImage(named: "Hats2")!, clothesCategory: .hat, season: .all, mainColor: .brown, tags: nil, brandName: nil, meterial: nil),
        Clothes(itemImage: UIImage(named: "Hats3")!, clothesCategory: .hat, season: .all, mainColor: .black, tags: nil, brandName: nil, meterial: nil),
